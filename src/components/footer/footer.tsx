const Footer = (): any => {
  return (<>
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full  md:px-24 lg:px-8 dark:bg-slate-800 text-white">
      <Discription />
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4 mt-4">
        <div className="sm:col-span-2">
          <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
            ...
            <span className="ml-2 text-xl font-bold tracking-wide text-orange-500 ">CheckPrix</span>
          </a>
          <div className="mt-6 lg:max-w-sm">
            <p className="text-sm text-white">
           CheckPrix is a price comparison website for all popular online shops in Mauritius. We do not sell products or services. We compare prices on different e-commerce websites in Mauritius and provide links to product pages on those sites.
            </p>
        ...
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 text-white">
                <path
            ...
            <a href="/" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
              <svg viewBox="0 0 30 30" fill="currentColor" className="h-6 text-white">
...
const Discription = (): any => {
  return (<>
    <div className="flex flex-col gap-4 pb-5 text-sm break-words text-white">
      ...
      <p>
        We solve a critical part of your online shopping experience. People generally research for mobile smartphones, tablets, and laptops online by checking specifications, competitor products, reviews, photos, and comparing price of the final product on different websites and shops. CheckPrix brings much of that experience under one roof: our website enables you to view product specifications, see similar products, and photos, etc. More importantly, we list prices from all popular online shopping websites so you can find the lowest price of mobile smartphones, tablets, and laptops without having to go to separate online shopping websites!
      </p>
    </div>
  </>)
}
...
const Disclaimer = (): any => {
  return (<>
    <div className="flex flex-col gap-4 pb-5 text-sm break-words text-white">
      <p>
        <span className="text-orange-500 font-semibold">Disclaimer:</span> CheckPrix is a price comparison website and does not claim ownership of all trademarks, logos, product names, brands, images, links to external websites, price and offers and are therefore the sole properties of their rightful owners and holders. They are only used on CheckPrix for the purpose for which they are to serve or serve.
      </p>
    </div>
  </>)
}