          ...
          <div className="flex flex-col items-center ">
            ...
            <CurrentPage parent={"Home"} child={"Abouts us"}/>
              ...
              <p className="text-sm lg:text-base pl-5 pr-5 ">
                CheckPrix is a Data Service Company with focus on data
                collection, data entry, data organisation, data cleansing, data
                management, data storage, data presentation and data publishing.
              </p>
              <p className="text-sm lg:text-base pl-5 pr-5 pt-3">
                CheckPrix was started when we realised the lack of data in
                general, lack of organised data, as well as well organised
                databases and sources for timely and reliable data and data
                service in Mauritius. As such, we begun our journey in May 2021
                to resolve this.
              </p>
              <p className="text-sm lg:text-base pl-5 pr-5 pt-3">
                We are committed to becoming a reliable and a one stop shop for
                all your data and related service needs in Mauritius and the
                world at large.
              </p>
            </div>

            <div className="flex justify-center pt-10">
              <span className="uppercase text-2xl text-gray-400">
                Our core values
              </span>
            </div>
            ...
            <div className="w-full lg:max-w-7xl pt-5 pl-5 pr-5">
              <span className="block text-center font-medium text-gray-500">
                In a world of inundating data especially in the advent of the
                internet, it is always difficult to find what you want at the
                right time.
              </span>
